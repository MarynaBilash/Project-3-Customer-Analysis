...
#Distribution of clusters as per the various products.
plt.figure()
...
#Cluster 2 is our biggest set of customers closely followed by cluster 0.


# In[31]:


#Explore campaigns in past.
...
#Best outcome:cluster 0 and cluster 3.
#Cluster 2 are not much into the deals.
#Offers not attract cluster 1.
